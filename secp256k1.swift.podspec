...
Bitcoin, Ethereum and many other Cryptocurrency Signature generation and verification.
  ...
  s.pod_target_xcconfig = {
    ...
    'OTHER_CFLAGS' => '-DENABLE_MODULE_EXTRAKEYS -DENABLE_MODULE_SCHNORRSIG -pedantic -Wall -Wextra -Wcast-align -Wnested-externs -Wshadow -Wstrict-prototypes -Wno-shorten-64-to-32 -Wno-conditional-uninitialized -Wno-unused-function -Wno-long-long -Wno-overlength-strings -O3',
  ...
  s.exclude_files = 'Sources/secp256k1/src/test*.{c,h}', 'Sources/secp256k1/src/gen_context.c', 'Sources/secp256k1/src/*bench*.{c,h}', 'Sources/secp256k1/src/modules/{recovery,ecdh,extrakeys,schnorrsig}/*test*.{c,h}'
